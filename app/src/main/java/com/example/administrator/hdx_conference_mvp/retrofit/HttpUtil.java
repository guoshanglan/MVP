...
import com.example.administrator.hdx_conference_mvp.retrofit.interfaces.HeadersInterceptor;
import com.example.administrator.hdx_conference_mvp.retrofit.interfaces.ParamsInterceptor;
import com.example.administrator.hdx_conference_mvp.retrofit.utils.OkhttpProvidede;
...
public class HttpUtil {
    ...
    //构造函数私有，不允许外部调用
    private HttpUtil(apiservice mService, Context mAppliactionContext, ParamsInterceptor mParamsInterceptor, HeadersInterceptor mHeadersInterceptor) {
    ...
    public static class SingletonBuilder {
        ...
        public HttpUtil build() {
            ...
            Retrofit retrofit = builder
                    .baseUrl(baseUrl + "/")
                    .client(client).build();
            apiservice retrofitHttpService =
